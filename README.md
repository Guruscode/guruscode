...
### 🌱 Currently Learning:
- EVERYTHING ABOUT BLOCKCHAIN [Go, Solidity Web3.js].
- MOBILE ENGINEERING
- Data Structures and Algorithms (DSA)

### 🍃 Current Projects:
- A smart Digital Assitance for everyday life(Web,Mobile,Blockchain,Ml,Al,cloud)
- A Daily Chore Handler (Case-study : OurEdenlife)
- An All in one Marketting Application
